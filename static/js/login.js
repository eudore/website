...
var Index = {
	view: function(vnode) {
		return m("form#slick-login", [
			...
			m("div", [
				// m("button", {onclick: sss}, m("svg", {
				m("a", {
					onclick: oauth2func('/api/v1/auth/login/oauth2/github'),
					href: "/api/v1/auth/login/oauth2/github" + (redirect=="" ? "": ("?location=" +redirect))
				}, m("svg", {
					width: 36,
					height: 36,
					viewBox: "0 0 16 16",
				...
				m("a", {
					onclick: oauth2func('/api/v1/auth/login/oauth2/gitlab'),
					href: "/api/v1/auth/login/oauth2/gitlab" + (redirect=="" ? "": ("?location=" +redirect))
				}, m("svg", {
					width: 36,
					height: 36,
					viewBox: "0 0 36 36",
